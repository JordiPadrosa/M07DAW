...
// Segons el $_GET crida la funcio signup_error() o signin_error() i li passa l'string corresponent
if(isset($_GET["signup_campsObligatoris_error"])){
    signup_error("Tots els camps son obligatoris");    
}
if(isset($_GET["signup_correuExisteix_error"])){
    signup_error("El correu ja existeix");    
}
if(isset($_GET["signup_nom_llarg"])){
    signup_error("El nom pot tenir màxim 20 caràcters");    
}
if(isset($_GET["signup_correu_llarg"])){
    signup_error("El correu pot tenir màxim 30 caràcters");    
}
if(isset($_GET["signup_contrasenya_llarga"])){
    signup_error("La contrasenya pot tenir màxim 32 caràcters");    
}
...
if(isset($_GET["signin_correu_llarg"])){
    signin_error("El correu pot tenir màxim 30 caràcters");    
}
